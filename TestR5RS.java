...
//    public TestR5RS2(String name)
//    {
//        //super(name);
//    }
public static void main(String[] args) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException {
	TestR5RS4 self = new TestR5RS4();
	for(Method m:TestR5RS4.class.getMethods()){
		if(m.getName().startsWith("test")){
			System.out.println("def "+m.getName()+"(self):");
			m.invoke(self);
		}
	}
}
...
//    }
    ...
    private String evalT(String expression)
//        throws IOException, SchemeException
    {
    	System.out.println("    self.eval(r\"\"\" "+expression+" \"\"\")");
        return null;
    	//return interpreter.eval(quote(expression));
    }
    private String evalF(String expression)
//  throws IOException, SchemeException
{
	System.out.println("    self.evalF(r\"\"\" "+expression+" \"\"\")");
  return null;
	//return interpreter.eval(quote(expression));
}
    private void check(String in, String out)
        //throws IOException, SchemeException
    {
    	System.out.println("    self.equal(r\"\"\" "+in+" \"\"\",r\"\"\" "+out+" \"\"\")");
//        Value   value   = eval(in);
...
//        throws Exception
    {
        evalT("(define (f) (list 'not-a-constant-list))");
        evalT("(define (g) '(constant-list))");
//
//        // set-car!
        evalT("(set-car! (f) 3)");
//        try
...
//        throws Exception
    {
        evalT("(define (f) (make-string 3 #\\*))");
        evalT("(define (g) \"***\"))");
//
        evalT("(string-set! (f) 0 #\\?)");
//
//        try
//        {
            evalF("(string-set! (g) 0 #\\?)");
//            fail();
//        }
//        catch (SchemeException e)
//        { }
...
//        try
//        {
            evalF("(string-set! (symbol->string 'immutable) 0 #\\?)");
//            fail();
//        }
//        catch (SchemeException e)
//        { }
